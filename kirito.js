...
<div class="col-4 text-success lead" style="width:200px;height:200px">
	...
	<div class="card-body">
		...
		<textarea>Kirigaya Kazuto (桐ヶ谷 和人 Kazuto Kirigaya), born as Narusaka Kazuto (鳴坂 和人 Kazuto Narusaka), and known as Kirito (キリト) in «Sword Art Online» (SAO), «ALfheim Online» (ALO), «Gun Gale Online» (GGO), and «Project Alicization», is the protagonist of the main Sword Art Online series.
		</textarea>
</div>
